...
const certificates = [
  {
    title: "Аттестация оборудования",
    issuer: "Росстандарт",
    description: "Аттестация испытательного оборудования по государственным стандартам РФ",
  ...
  },
  {
    ...
    description: "Аккредитация в национальной системе для проведения испытаний и измерений",
    icon: "M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z",
    color: "from-emerald-500 to-teal-600",
  },
  {
    title: "Система менеджмента качества",
    issuer: "Сертифицированная СМК",
    description: "Внедрённая и сертифицированная система управления качеством услуг",
  ...
  },
  {
    title: "Право поверки",
    issuer: "Росстандарт",
    description: "Право проведения поверки средств измерений на территории РФ",
      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <p className="text-neutral dark:text-white/60 mt-4 max-w-2xl mx-auto">
            Все работы выполняются в соответствии с российскими стандартами и нормативами
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm">Российские стандарты</span>
          </div>
          <div className="flex items-center gap-2">
            <svg className="w-5 h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
