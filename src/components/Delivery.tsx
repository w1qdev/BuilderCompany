...
const steps: Steps[] = [
  {
    ...
    description:
      "Самостоятельно. Для заказчиков из г.Москва есть возможность доставить средства измерения или испытательное оборудование в нашу лабораторию.",
    icon: Motorbike,
  ...
  },
  {
    ...
    description:
      "Нашей курьерской службой. В отличие от ФБУ «Ростест-Москва» если у Вас нет возможности, привести лично или Вы находитесь в других городах, мы пришлём к Вам представителя компании, он примет прибор и доставит в нашу лабораторию. После проведения метрологических работ, Ваше СИ будет доставлено курьером лично в руки с бухгалтескими документами и свидетельством о поверке/калибровке/аттестации. Средняя стоимость доставки по России за 600-1000 рублей в одну сторону в зависимости от количества приборов.",
  ...
  },
  {
    ...
    description:
      "Транспортной компанией. Если есть желание сэкономит на доставке, можно воспользоваться услугами ТК Деловые Линии, ПЭК или другими на Ваш выбор. Доставка в среднем выходит от 500 рублей в зависимости от габаритов.",
