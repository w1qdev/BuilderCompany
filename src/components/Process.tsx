...
const steps = [
  ...
  },
  {
    number: "02",
    title: "Анализ",
    description: "Изучаем ваше оборудование, определяем объём работ и согласовываем сроки выполнения.",
  ...
  },
  {
    number: "03",
    title: "Работа",
    description: "Проводим калибровку, поверку или сертификацию с использованием эталонного оборудования.",
  ...
  },
  {
    number: "04",
    title: "Документы",
    description: "Выдаём сертификат калибровки, свидетельство о поверке или другие необходимые документы.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-dark mt-2">
            Простой процесс — <span className="text-gradient">точный результат</span>
          </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {steps.map((step, index) => (
              <motion.div
                ...
                className="relative"
              >
                <div className="bg-warm-bg rounded-3xl p-6 h-full relative z-10 hover:shadow-xl transition-shadow duration-300">
                  {/* Number badge */}
