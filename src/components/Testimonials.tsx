                ...
                <div className="flex items-center justify-between flex-wrap gap-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-white/60 text-sm">{testimonials[currentIndex].position}</div>
                      <div className="text-primary text-sm font-medium">{testimonials[currentIndex].company}</div>
                    </div>
                  </div>
