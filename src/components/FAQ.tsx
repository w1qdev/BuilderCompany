...
const faqs: Faqs[] = [
  ...
  },
  {
    ...
    answer:
      "Стандартные сроки калибровки — 5-10 рабочих дней. Для срочных заказов предусмотрена ускоренная калибровка за 1-3 дня с дополнительной оплатой. Точные сроки зависят от типа и количества оборудования.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Да, наш центр аккредитован в национальной системе аккредитации (Росаккредитация). Также мы сертифицированы по ISO 17025 — международному стандарту для испытательных и калибровочных лабораторий.",
  },
];
