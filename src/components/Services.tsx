...
const tabContent: Record<string, TabContent> = {
  "1": {
    ...
    description:
      "Аттестация испытательного оборудования — это комплексная процедура оценки технического состояния и подтверждения соответствия оборудования установленным требованиям. Мы проводим полный цикл аттестационных испытаний с применением современных эталонных средств измерений и в строгом соответствии с требованиями ГОСТ.",
    features: [
