...
const tabs: Tabs[] = [
  ...
  {
    id: "2",
    label: "Поверка измерителей электрических величин",
    services: [
      {
  ...
  {
    id: "3",
    label: "Поверка систем испытательных",
    services: [
      {
  ...
  {
    id: "5",
    label: "Калибровка средств измерений",
    services: [
      {
        title: "Поверка счётчиков;",
        description:
    ...
    <section id="services" className="py-20 sm:py-28 dark:bg-dark">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <span className="text-primary font-semibold text-sm uppercase tracking-wider mt-5">
            Что мы делаем:
          </span>
        </motion.div>
          ...
          >
            <ul>
              {activeTabData.services.map((service) => (
                <h3
                  key={service.title}
                  className="text-lg font-bold text-dark dark:text-white mb-2"
                >
                  - {service.title}
                </h3>
              ))}
