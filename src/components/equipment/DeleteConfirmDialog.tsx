...
export default function DeleteConfirmDialog({
  ...
  return (
    <Portal>
      <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" role="button" tabIndex={-1} onClick={() => !deleting && onCancel()} onKeyDown={(e) => { if ((e.key === "Enter" || e.key === " ") && !deleting) { e.preventDefault(); onCancel(); } }}>
        <div role="dialog" className="bg-white dark:bg-dark-light rounded-2xl shadow-xl max-w-sm w-full p-6" onClick={(e) => e.stopPropagation()} onKeyDown={(e) => { e.stopPropagation(); }}>
