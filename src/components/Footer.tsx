        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <h3 className="text-2xl sm:text-3xl font-extrabold mb-2">
              Готовы начать <span className="text-gradient">строительство?</span>
            </h3>
            <p className="text-white/60">Оставьте заявку и получите бесплатную консультацию</p>
          </div>
          <button
            onClick={onOpenModal}
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-xl">СтройКомпани</span>
            </div>
            <p className="text-white/60 text-sm leading-relaxed">
              Надёжный партнёр в строительстве с 2009 года. Полный спектр строительных услуг для частных и коммерческих объектов.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Строительство", "Ремонт", "Проектирование", "Дизайн", "Кровля", "Фасады"].map((s) => (
                <li key={s}>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                ...
                <span className="text-white/60 text-sm">г. Москва, ул. Строителей, д. 15, офис 301</span>
              </li>
              <li>
                <a href="tel:+78001234567" className="flex items-center gap-2 text-white/60 hover:text-primary transition-colors text-sm">
              ...
              <li>
                <a href="mailto:info@stroycompany.ru" className="flex items-center gap-2 text-white/60 hover:text-primary transition-colors text-sm">
                  <svg className="w-5 h-5 text-primary shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-white/40 text-sm">
            &copy; 2024 СтройКомпани. Все права защищены.
          </p>
