...
const RESPONSE_TEMPLATES = [
  {
    ...
    text: "Ваша заявка принята в работу. Мы свяжемся с вами в ближайшее время для уточнения деталей.",
  },
  {
    label: "Запрос документов",
    text: "Для обработки заявки нам необходимы дополнительные документы. Пожалуйста, предоставьте копии свидетельств о поверке.",
  },
  {
    label: "Готово к выдаче",
    text: "Работы по вашей заявке завершены. Документы готовы к выдаче. Свяжитесь с нами для получения.",
  },
  {
    label: "Ожидание оплаты",
    text: "Счёт на оплату направлен на вашу электронную почту. После оплаты мы приступим к выполнению работ.",
  },
  {
    label: "Уточнение данных",
    text: "Просим уточнить данные по заявке: наименование СИ, заводской номер и номер в реестре ФИФ.",
  },
];
...
export default function AdminPage() {
  ...
  const handleBulkDelete = async () => {
    ...
    if (
      !confirm(
        `Удалить ${selectedIds.size} заявок? Это действие нельзя отменить.`
      )
    )
      return;
    setBulkLoading(true);
  ...
  const handleExportToExcel = async (id: number, filter?: string) => {
    ...
    try {
      toast.loading("Формирование Excel файла...", {
        id: `export-${id}-${filterLabel}`,
      });
  ...
  const statsCards = [
    ...
    },
    {
      ...
      iconBg:
        "bg-blue-200 text-blue-600 dark:bg-blue-500/20 dark:text-blue-400",
    },
    {
      key: "in_progress",
      label: "В работе",
      ...
      iconBg:
        "bg-yellow-200 text-yellow-600 dark:bg-yellow-500/20 dark:text-yellow-400",
    },
    {
      key: "pending_payment",
      ...
      iconBg:
        "bg-orange-200 text-orange-600 dark:bg-orange-500/20 dark:text-orange-400",
    },
    {
      key: "done",
      label: "Завершены",
      ...
      iconBg:
        "bg-green-200 text-green-600 dark:bg-emerald-500/20 dark:text-emerald-400",
    },
    {
      key: "cancelled",
      label: "Отменены",
  ...
  return (
    <TooltipProvider>
        ...
        {statsCards.map((card, index) => (
          ...
          >
            <button
              ...
              className={`${
                card.bg
              } w-full rounded-2xl shadow-sm p-4 text-left transition-shadow hover:shadow-md ${
              ...
              <TooltipTrigger asChild>
                <button
                  ...
                  className={`p-2 rounded-xl border transition-colors ${
                    soundEnabled
                      ? "bg-white dark:bg-dark-light border-gray-200 dark:border-white/10 text-neutral dark:text-white/50 hover:bg-gray-50 dark:hover:bg-white/5"
                      : "bg-gray-100 dark:bg-white/10 border-gray-300 dark:border-white/15 text-gray-400 dark:text-white/40"
                  }`}
                >
                  <svg
                    className="w-4 h-4"
      ...
      <div className="flex md:hidden items-center gap-2 mb-4">
        <span className="text-xs text-neutral dark:text-white/50 shrink-0">
          Сортировка:
        </span>
        <Select
            ...
            {requests.map((r) => (
              ...
              >
                ...
                >
                  ...
                  <div className="text-sm text-neutral dark:text-white/70 truncate">
                    {r.service}
                  </div>
                    ...
                    <div className="space-y-3">
                      ...
                      {((r.files && r.files.length > 0) ||
                        ...
                        <div>
                          <div className="text-xs text-neutral dark:text-white/50 mb-1 font-medium uppercase tracking-wide">
                            Прикрепленные файлы (
                            {r.files && r.files.length > 0 ? r.files.length : 1}
                            )
                          </div>
                      ...
                      <div className="pt-3 border-t border-gray-200 dark:border-white/10">
                        <div className="text-sm font-semibold text-dark dark:text-white mb-3 uppercase tracking-wide">
                      ...
                      <div className="pt-3 border-t border-gray-200 dark:border-white/10">
                        ...
                        <div className="flex flex-wrap gap-2">
                          <a
                            href={`tel:${r.phone}`}
                            className="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-xs font-medium bg-green-50 text-green-700"
                          >
                            <svg
                          ...
                          <a
                            href={`mailto:${r.email}`}
                            className="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-xs font-medium bg-blue-50 text-blue-700"
                          >
                            <svg
                              className="w-3.5 h-3.5"
                              fill="none"
                        ...
                        <div className="relative">
                          ...
                          {exportMenuId === r.id && (
                            ...
                            >
                              ...
                              <button
                                onClick={() =>
                                  handleExportToExcel(r.id, "поверка")
                                }
                                className="w-full text-left px-4 py-2 text-xs hover:bg-gray-50 transition-colors text-dark"
                              >
                                Только поверки
                              ...
                              <button
                                onClick={() =>
                                  handleExportToExcel(r.id, "аттестация")
                                }
                                className="w-full text-left px-4 py-2 text-xs hover:bg-gray-50 transition-colors text-dark"
                              >
                                Только аттестации
                              ...
                              <button
                                onClick={() =>
                                  handleExportToExcel(r.id, "калибровка")
                                }
                                className="w-full text-left px-4 py-2 text-xs hover:bg-gray-50 transition-colors text-dark"
                              >
                                Только калибровки
                ...
                {Array.from({ length: pages }, (_, i) => i + 1).map((p) => (
                  <button
                    ...
                    className={`w-8 h-8 rounded-lg text-sm font-medium transition-colors ${
                      page === p
                        ? "bg-primary text-white"
                        : "bg-white dark:bg-dark-light text-neutral dark:text-white/50 hover:bg-gray-100 dark:hover:bg-white/10"
                    }`}
                  >
                    {p}
                  </button>
                ...
                {requests.map((r) => (
                  <Fragment key={r.id}>
                    ...
                    >
                      ...
                      <TableCell className="text-neutral dark:text-white/50">
                        {r.id}
                      </TableCell>
                    ...
                    {expandedId === r.id && (
                      ...
                      >
                        <TableCell
                          colSpan={8}
                          className="bg-warm-bg/30 dark:bg-white/5"
                        >
                          <div className="grid sm:grid-cols-2 gap-4">
                            ...
                            <div className="space-y-2">
                              ...
                              <div>
                                ...
                                <div className="text-sm text-dark dark:text-white">
                                  {r.name} &middot; {r.phone} &middot; {r.email}
                                  ...
                                  onValueChange={(value) => {
                                    fetch(`/api/admin/${r.id}`, {
                                      ...
                                      if (res.ok) {
                                        ...
                                        fetchStats();
                                        toast.success(
                                          `Статус изменён: ${statusLabels[value]?.label}`
                                        );
                                      }
                                    });
                                  }}
            ...
            <div className="flex items-center justify-between p-4 border-b border-gray-100">
              <div>
                ...
                <p className="text-sm text-neutral">
                  {clientHistory.email} — {clientHistory.requests.length} заявок
                </p>
              </div>
              <button
                onClick={() => setClientHistory(null)}
            ...
            <div className="p-4 overflow-y-auto max-h-[60vh] space-y-3">
              {clientHistory.requests.length === 0 ? (
                ...
                clientHistory.requests.map((req) => (
                  <div
                    key={req.id}
                    className="bg-warm-bg/50 rounded-xl p-3 space-y-1"
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <Badge
                        variant={statusLabels[req.status]?.variant || "default"}
                      >
