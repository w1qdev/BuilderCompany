  ...
  if (error) {
    return (
      <div className="text-center py-20">
        <div className="bg-red-50 text-red-600 text-sm rounded-xl px-4 py-3 inline-block">
          {error}
        </div>
      </div>
    );
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        {statsCards.map((card) => (
          <button
            ...
            className={`${card.bg} rounded-2xl p-4 text-left transition-shadow hover:shadow-md ${
