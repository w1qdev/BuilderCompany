...
export default function AdminError({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 px-4 text-center dark:bg-dark">
      ...
      <h2 className="text-lg font-bold text-dark dark:text-white mb-2">Ошибка загрузки</h2>
