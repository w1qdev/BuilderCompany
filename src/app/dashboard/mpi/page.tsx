    ...
    <div className="max-w-4xl space-y-6">
      ...
      <div className="bg-white dark:bg-dark-light rounded-2xl p-6 border border-gray-100 dark:border-white/10">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-5 py-2 bg-primary text-white rounded-xl text-sm font-medium hover:bg-primary/90 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
        >
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-gray-50 dark:divide-white/5">
              {[
                ["Манометры", "12 мес.", "ГОСТ"],
                ["Термометры ртутные", "12 мес.", "ГОСТ"],
                ["Весы лабораторные", "12 мес.", "ГОСТ"],
                ["Счётчики электроэнергии", "16 лет (однофаз.) / 10 лет (трёхфаз.)", "ПП РФ"],
                ["Тепловычислители", "4 года", "ГОСТ"],
                ["Расходомеры", "4 года", "МИ"],
                ["Мультиметры", "12 мес.", "ПО на прибор"],
                ["Микрометры", "12 мес.", "ГОСТ"],
                ["Штангенциркули", "12 мес.", "ГОСТ"],
