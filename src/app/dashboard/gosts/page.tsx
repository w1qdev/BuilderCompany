...
const gostCategories = [
  {
    ...
    gosts: [
      ...
      {
        code: "ГОСТ Р 8.568-2017",
        name: "ГСИ. Аттестация испытательного оборудования",
      },
      {
        code: "ГОСТ Р 8.879-2014",
        name: "ГСИ. Методики калибровки средств измерений",
      },
    ],
  },
  {
    ...
    gosts: [
      {
        code: "ГОСТ Р 8.395-80",
        name: "ГСИ. Нормальные условия измерений при поверке",
      },
      {
        code: "ГОСТ Р 8.596-2002",
        name: "ГСИ. Метрологическое обеспечение измерительных систем",
      },
      {
        code: "ГОСТ 8.061-80",
        name: "ГСИ. Поверочные схемы. Содержание и построение",
      },
      {
        code: "ГОСТ 8.009-84",
        name: "ГСИ. Нормируемые метрологические характеристики средств измерений",
      },
    ],
  },
  {
    ...
    gosts: [
      ...
      {
        code: "ГОСТ 8.207-76",
        name: "ГСИ. Прямые измерения с многократными наблюдениями",
      },
  ...
  },
  {
    ...
    gosts: [
      {
        code: "ГОСТ 8.558-2009",
        name: "ГСИ. Государственная поверочная схема для средств измерений температуры",
      },
      {
        code: "ГОСТ 6651-2009",
        name: "Термопреобразователи сопротивления из платины, меди и никеля",
      },
      {
        code: "ГОСТ Р 8.585-2001",
        name: "ГСИ. Термопары. Номинальные статические характеристики преобразования",
      },
  ...
  },
  {
    ...
    gosts: [
      {
        code: "ГОСТ 8.271-77",
        name: "ГСИ. Средства измерений давления. Термины и определения",
      },
      {
        code: "ГОСТ 2405-88",
        name: "Манометры, вакуумметры, мановакуумметры, напоромеры",
      },
      {
        code: "ГОСТ 8.092-73",
        name: "ГСИ. Манометры, вакуумметры, мановакуумметры. Методы поверки",
      },
      {
        code: "ГОСТ Р 8.802-2012",
        name: "ГСИ. Государственная поверочная схема для средств измерений избыточного давления",
      },
    ],
  },
  {
    ...
    gosts: [
      {
        code: "ГОСТ 8.027-2001",
        name: "ГСИ. Государственная поверочная схема для средств измерений постоянного электрического напряжения и ЭДС",
      },
      {
        code: "ГОСТ 8.022-91",
        name: "ГСИ. Государственный первичный эталон и государственная поверочная схема для средств измерений силы постоянного электрического тока",
      },
      {
        code: "ГОСТ 8.028-86",
        name: "ГСИ. Государственный первичный эталон и государственная поверочная схема для средств измерений электрического сопротивления",
      },
      {
        code: "ГОСТ 22261-94",
        name: "Средства измерений электрических и магнитных величин. Общие технические условия",
      },
    ],
  },
];
