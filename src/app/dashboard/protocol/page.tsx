      ...
      <div className="bg-white dark:bg-dark-light rounded-2xl shadow-sm p-6 space-y-4">
        ...
        <div className="flex gap-3 pt-4">
          <button
            ...
            disabled={generating}
            className="inline-flex items-center gap-2 px-6 py-2.5 bg-primary text-white rounded-xl text-sm font-semibold hover:bg-primary-dark transition-colors disabled:opacity-50"
          >
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium bg-gray-100 dark:bg-white/5 text-neutral hover:bg-gray-200 transition-colors"
          >
