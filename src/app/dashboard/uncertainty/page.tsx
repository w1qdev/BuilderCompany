  ...
  return (
    <div>
      ...
      <p className="text-sm text-neutral dark:text-white/60 mb-6">
        Расчёт стандартной и расширенной неопределённости по типу A и типу B (ГОСТ)
      </p>
      ...
      {mode === "typeA" && (
        <div className="bg-white dark:bg-dark-light rounded-2xl shadow-sm p-6">
          ...
          <button
            ...
            className="mt-4 inline-flex items-center gap-2 px-6 py-2.5 bg-primary text-white rounded-xl text-sm font-semibold hover:bg-primary-dark transition-colors"
          >
        ...
        <div className="bg-white dark:bg-dark-light rounded-2xl shadow-sm p-6">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-6 py-2.5 bg-primary text-white rounded-xl text-sm font-semibold hover:bg-primary-dark transition-colors"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" /></svg>
              Рассчитать
            </button>
      ...
      <div className="mt-6 bg-blue-50 dark:bg-blue-900/10 rounded-2xl p-5">
        ...
        <div className="text-sm text-neutral dark:text-white/60 space-y-1">
          ...
          <p className="text-xs mt-2">Нормативная база: ГОСТ (ISO/IEC Guide 98-3:2008), РМГ</p>
        </div>
      </div>
    </div>
  );
