        ...
        <div className="bg-white dark:bg-dark-light rounded-2xl shadow-lg p-8 sm:p-12">
          ...
          <div className="space-y-6 text-neutral dark:text-white/60 text-sm leading-relaxed">
            ...
            <section>
              ...
              <h3 className="font-semibold text-dark dark:text-white mt-3 mb-1">
                2.2. При регистрации и использовании личного кабинета:
              </h3>
              <ul className="list-disc pl-6 space-y-1">
                <li>Фамилия, имя, отчество</li>
                <li>Адрес электронной почты</li>
                ...
                <li>Должность (опционально)</li>
                <li>ИНН, КПП, юридический адрес организации (опционально)</li>
                <li>Аватар и изображение обложки профиля (опционально)</li>
                <li>Часовой пояс</li>
              </ul>
              <h3 className="font-semibold text-dark dark:text-white mt-3 mb-1">
                2.3. Автоматически при посещении сайта и входе в аккаунт:
              </h3>
              <ul className="list-disc pl-6 space-y-1">
                <li>Технические данные браузера (User-Agent)</li>
                <li>IP-адрес</li>
                <li>Дата, время и устройство входа (журнал входов)</li>
                <li>Информация об активных сессиях</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 mt-2 space-y-1">
                ...
                <li>Обеспечение работы личного кабинета, авторизации и управления сессиями</li>
                <li>Формирование отчётных документов (экспорт заявок и оборудования)</li>
                <li>Отправка уведомлений о статусе заявки и сроках поверки (email, Telegram)</li>
                <li>Персонализация интерфейса (тема оформления, размер шрифта, компактный режим)</li>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 mt-2 space-y-1">
                ...
                <li>Контроль активных сессий с возможностью их отзыва</li>
                ...
                <li>Возможность удаления аккаунта с полным удалением всех данных</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                доступна на данной странице. Дата последнего обновления: март
                2026 г.
              </p>
            </section>
          </div>
