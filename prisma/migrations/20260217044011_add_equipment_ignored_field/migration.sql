...
INSERT INTO "new_Equipment" ("arshinCheckedAt", "arshinMismatch", "arshinNotifiedDate", "arshinUrl", "arshinValidDate", "category", "company", "contactEmail", "createdAt", "id", "interval", "mitApproved", "mitUrl", "name", "nextVerification", "notes", "notified", "registryNumber", "serialNumber", "status", "type", "updatedAt", "userId", "verificationDate") SELECT "arshinCheckedAt", "arshinMismatch", "arshinNotifiedDate", "arshinUrl", "arshinValidDate", "category", "company", "contactEmail", "createdAt", "id", "interval", "mitApproved", "mitUrl", "name", "nextVerification", "notes", "notified", "registryNumber", "serialNumber", "status", "type", "updatedAt", "userId", "verificationDate" FROM "Equipment";
